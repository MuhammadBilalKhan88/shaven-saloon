...
$getid = $_GET['id'];
$qurey = "SELECT * FROM booking_appointment WHERE appintmnet_id=$getid";
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $row["client_Email"] ?>"
                                        name="email" id="exampleInputEmail1" aria-describedby="emailHelp">

                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Phone Number</label>
                                    <input type="text" class="form-control" value="<?php echo $row["client_Pnumber"] ?>"
                                        name="email" id="exampleInputEmail1" aria-describedby="emailHelp">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Service Name & Pricing</label>
                                    ...
                                    <select name="employee" class="form-control">
                                        ...
                                        while ($row = mysqli_fetch_assoc($res)) {
                                            ...
                                            <option value="<?php echo $row["our_Team_Name"]; ?>">
                                                <img src="images/ourteam/<?php echo $row["our_Team_Image"]; ?>"
                                                    alt="Team Member"
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Appointment DateTime</label>
                                    <input type="datetime-local" class="form-control" name="email"
                                        id="exampleInputEmail1" aria-describedby="emailHelp">

                                </div>

                                <button type="submit" class="btn btn-primary" name="editappointment">Edit User
                                    Accoounct</button>
                            </form>
                        </div>
                    </div>
