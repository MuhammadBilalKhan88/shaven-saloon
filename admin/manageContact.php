...
<?php include("./Database/connection.php") ;error_reporting(0); ?>
                            ...
                            <tbody>
                                ...
                                while ($row  = mysqli_fetch_array($res)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <textarea rows="6" cols="50"><?php echo $row[4]  ?></textarea>

                                        </td>
                                        <td><a class="btn btn-sm bg-warning text-white" href="editContact.php?id=<?php  echo $row[0]; ?>">Edit</a>
                                     <a class="btn btn-sm btn-primary" href="DeleteContact.php?id=<?php echo $row[0];?>">Delete</a>
                                    </tr>
                                <?php }
