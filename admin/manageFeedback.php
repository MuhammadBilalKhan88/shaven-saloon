                    ...
                    <div class="table-responsive">
                        <table id="example" class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                $qurey  = "SELECT * FROM saloon_feedback";
                                ...
                                while ($row  = mysqli_fetch_array($res)) { ?>
                                    <tr>
                                        ...
                                        <td><a class="btn btn-sm bg-warning text-white" href="editFeedback.php?id=<?php  echo $row[0]; ?>">Edit</a>
                                     <a class="btn btn-sm btn-primary" href="DeleteFeedback.php?id=<?php echo $row[0];?>">Delete</a>
                                    </tr>
                                <?php }
